    ...
    <div class="paragraphe1">
      ...
      <p class="seul">
        ...
        <?php if (isset($_SESSION['yin'])&&$_SESSION['yin']=='used') {
          echo "<i> «Clément dans ma poche le yin yang. Vite sur ma main !»</i> Il s'execute et pose l'objet contre ta main.<br>";
        } ?> Tu presses la gâchette de gauche. Une énorme détonation se fait entendre. <br>
      ...
      <div class="paragraphe2">
        <p class="droite" style="margin-top : px">
          ...
          <i>«Dis Clément, tu crois que Prisca a survécu ? Vous aviez tous disparu et la mort m'a fauché et me revoilà ici.»<br>
            -«Pour être honnête, je ne comprends pas vraiment ce que tu dis. Prisca ? Elle était là ?»</i> te demande-t'il avec confusion.
