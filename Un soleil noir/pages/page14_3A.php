...
<body>
  <div class="paragraphe">
    <div class="paragraphe1">
      ...
      <p class="seul">
      Tu réfléchis quelques secondes. Tu as une chance sur deux.
        <?php if (isset($_SESSION['yin'])&&$_SESSION['yin']=='used') {
        echo "Tu penses fort à ton yin yang et la réponse te vient alors : ";
      } ?> <i>«Je choisis... Glenn.» <br>
      ...
      Sa faux s'arrête alors sur Glenn. Tu avais raison. <br>
